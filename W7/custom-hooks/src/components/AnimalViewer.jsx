...
function AnimalViewer() {
    ...
    return ( 
        <>
            <h1>{mockData[count].animal}</h1>
            <p>{mockData[count].description}</p>
            <img src={mockData[count].image} style={{width:"400px"}}/>
            <div>
            <button onClick={() => handleDecrease()}>Previous Animal</button>
            <button onClick={() => handleReset()}>Reset</button>
            <button onClick={() =>handleIncrease()}>Next Animal</button>
            </div>
        </>
     );
}
